...
const callbackData = {
  ...
  payCardBrowser: CallbackAction.payCardBrowser,
...
export default {
  ...
  inlineKeyboardItem: {
    ...
    payCard: [{ text: "💳 Картой в боте", callback_data: callbackData.payCard }],
    payCardBrowser: [{ text: "🌐 Картой в браузере", callback_data: callbackData.payCardBrowser }],
