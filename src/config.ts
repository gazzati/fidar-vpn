...
export default {
  ...
  phrases: {
    ...
    MANUAL_MESSAGE: "⚙️ Wireguard: Инструкция по установке \n\n1️⃣ Установите приложение WireGuard по ссылке ниже\n\n2️⃣ Сохраните полученный файл подключения и импортируйте его в приложение WireGuard либо отсканируйте QR \n\n3️⃣ Для включения/отключения VPN активируйте добавленное подключение\n\n"
  },
